...
import savik.website.controller.GreetingsController;
...
public class MainControllerTest {
    ...
    public void mainPageTest() throws Exception {
        this.mockMvc.perform(get("/main"))
                ...
                .andExpect(xpath("/html/body/nav/div/div").string("savik"));
    }
    ...
    public void filterMessageTest() throws Exception {
        this.mockMvc.perform(get("/main").param("filter", "mytag"))
                .andDo(print())
                .andExpect(authenticated())
    ...
    public void addMessageToListTest() throws Exception {
        ...
        this.mockMvc.perform(multipart)
                ...
                .andExpect(xpath("//div[@id=\"message-list\"]/div[@data-id=10]/div/span").string("12345"))
